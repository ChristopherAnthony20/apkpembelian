...
public class MapsActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        final String[] placeTypeList = {"Tangerang", "Jakarta", "Bogor", "Depok", "Bekasi"};

        String[] placeNameList = {"Binus EzyFood: Tangerang", "Binus EzyFood: Jakarta", "Binus EzyFood: Bogor", "Binus EzyFood: Depok", "Binus EzyFood: Bekasi"};
